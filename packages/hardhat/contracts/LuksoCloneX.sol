...
// this is from https://medium.com/dropps/creating-nfts-on-lukso-step-by-step-guide-f2d195fb39a3
// NextJS frontend is added to demonstrate full interactions /packages/nextjs/nfts
...
import {_LSP8_TOKENID_TYPE_UNIQUE_ID} from "@lukso/lsp-smart-contracts/contracts/LSP8IdentifiableDigitalAsset/LSP8Constants.sol";
...
contract LuksoCloneX is LSP8IdentifiableDigitalAsset, ReentrancyGuard {
    ...
    uint256 constant PUBLIC_PRICE_PER_TOKEN = 0.01 ether;
    // uint256 constant PRIVATE_PRICE_PER_TOKEN = 0.01 ether;
    ...
    constructor(address owner_) LSP8IdentifiableDigitalAsset('LuksoCloneX', 'lCloneX', owner_, _LSP8_TOKENID_TYPE_UNIQUE_ID) {
        ...
        // _setData(_LSP8_TOKEN_ID_TYPE, hex"02"); // LSP8TokenIdTypeNotEditable()
