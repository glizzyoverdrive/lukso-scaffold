...
//         description: "Make sure the controlling account has some LXYt to cover the transaction costs",
//       });
//       return;
//     }
//     setIsUpdating(true);
...
//         description: error?.message || "Something went wrong while deploying your profile to the blockchain",
//         type: "error",
//         closeAfter: 6000,
//       });
//     }
...
//             <div className="mt-2">
//               <p className="text-sm text-gray-500">Enter a contract address of a Universal Profile</p>
//             </div>
//           </div>
//           <div className="my-3">
//             <TextInput
...
//                   Name
//                 </label>
//                 <TextInput name="name" className="mt-1" onChange={e => setName(e.currentTarget.value)} value={name} />
//               </div>
//               <div className="mt-4">
