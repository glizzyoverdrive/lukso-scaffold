export const RPC_URL_MAINNET = "https://rpc.mainnet.lukso.network";
export const CHAIN_ID_MAINNET = 42;
export const RPC_URL_TESTNET = "https://rpc.testnet.lukso.network";
export const CHAIN_ID_TESTNET = 4201;
export const IPFS_URL = "https://api.universalprofile.cloud/ipfs";

// keccak256('AddressPermissions[]')
export const PERMISSIONS_ARRAY = "0xdf30dba06db6a30e65354d9a64c609861f089545ca58c6b4dbe31a5f338cb0e3";
